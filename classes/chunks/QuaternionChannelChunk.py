...
class QuaternionChannelChunk(Chunk):
    @staticmethod
    def parseData(binaryReader: Pure3DBinaryReader) -> list:
        ...
        for _ in range(numFrames):
            values.append(binaryReader.readPure3DQuaternion())
        
        return [version, param, frames, values]

    def __init__(
        self, 
        identifier: int = chunkIdentifiers.QUATERNION_CHANNEL, 
    ...
    def writeData(self, binaryWriter: Pure3DBinaryWriter) -> None:
        ...
        for value in self.values:
            binaryWriter.writePure3DQuaternion(value)
