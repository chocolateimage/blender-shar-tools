...
class Vector2DOFChannelChunk(Chunk):
    @staticmethod
    def parseData(binaryReader: Pure3DBinaryReader) -> list:
        ...
        for _ in range(numFrames):
            values.append(binaryReader.readPure3DVector2())
        
        return [version, param, mapping, constants, frames, values]

    def __init__(
        self, 
        identifier: int = chunkIdentifiers.VECTOR_2D_OF_CHANNEL, 
    ...
    def writeData(self, binaryWriter: Pure3DBinaryWriter) -> None:
        ...
        for value in self.values:
            binaryWriter.writePure3DVector2(value)
