...
from classes.chunks.CompositeDrawableSkinListChunk import CompositeDrawableSkinListChunk
from classes.chunks.CompositeDrawablePropListChunk import CompositeDrawablePropListChunk
from classes.chunks.CompositeDrawableEffectListChunk import CompositeDrawableEffectListChunk
from classes.chunks.CompositeDrawableSortOrderChunk import CompositeDrawableSortOrderChunk
...
defaultChunkRegistry.register(chunkIdentifiers.COMPOSITE_DRAWABLE, CompositeDrawableChunk)
defaultChunkRegistry.register(chunkIdentifiers.COMPOSITE_DRAWABLE_SKIN_LIST, CompositeDrawableSkinListChunk)
defaultChunkRegistry.register(chunkIdentifiers.COMPOSITE_DRAWABLE_PROP_LIST, CompositeDrawablePropListChunk)
defaultChunkRegistry.register(chunkIdentifiers.COMPOSITE_DRAWABLE_EFFECT_LIST, CompositeDrawableEffectListChunk)
defaultChunkRegistry.register(chunkIdentifiers.COMPOSITE_DRAWABLE_SORT_ORDER, CompositeDrawableSortOrderChunk)
defaultChunkRegistry.register(chunkIdentifiers.COMPOSITE_DRAWABLE_PROP, CompositeDrawablePropChunk)
